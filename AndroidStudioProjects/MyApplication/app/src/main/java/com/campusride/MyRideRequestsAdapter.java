...
public class MyRideRequestsAdapter extends RecyclerView.Adapter<MyRideRequestsAdapter.RequestViewHolder> {
    private List<PassengerRideRequest> requests;

    public MyRideRequestsAdapter(List<PassengerRideRequest> requests) {
